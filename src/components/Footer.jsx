    ...
    return (
        <footer className={`bg-primary-dark/90 border-t border-accent-gold/20 py-10 ${page === 'cart' ? 'mt-auto' : ''}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h4 className="text-3xl font-serif font-bold text-accent-gold tracking-wider mb-3">Culinary Haven</h4>
                ...
                <p className="text-light-creme/50 text-sm">
                    &copy; 2025 The Culinary Haven. All rights reserved. | Built with React and Firebase.
                </p>
            </div>
        </footer>
    );
